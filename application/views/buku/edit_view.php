                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
								...
								<label>Sampul <small style="color:green">(gambar) * opsional</small></label>
									...
									<?php } else { ?>
									<br/>
									<div style="width:70px; height:70px; border:2px dashed #ddd; display:flex; align-items:center; justify-content:center; background-color:#f9f9f9; border-radius:4px; margin-top:5px;">
										<i class="fa fa-image" style="font-size:20px; color:#bbb;"></i>
									</div>
									<p style="color:#888; margin:5px 0 0 0; font-size:12px;">Tidak ada sampul</p>
									<?php } ?>
								</div>
                                <div class="form-group">
								<label>Lampiran Buku <small style="color:green">(pdf) * ganti opsional</small></label>
                                    ...
                                    <br>
									<?php if(!empty($buku->lampiran) && $buku->lampiran !== "0" && $buku->lampiran !== ""){?>
									...
									<?php } else { ?>
									<div style="display:inline-block; padding:8px 12px; background-color:#f5f5f5; border:1px solid #ddd; border-radius:4px; color:#888; margin-top:5px;">
